...
const filteredDone = mockDue2.filter(r => !isBotCheck(r.jid)).map(r => r.jid)
const filteredDue = mockDue2.filter(p => !isBotCheck(p.id)).map(p => p.id)

console.log('Original done: 162097098956948:3@lid, 204247287226396@lid, 95056367194249@lid')
console.log('Filtered done:', filteredDone)
console.log('Original due: 162097098956948:3@lid, 204247287226396@lid, 95056367194249@lid')
console.log('Filtered due:', filteredDue)
console.log('\n=== All tests completed ===')
